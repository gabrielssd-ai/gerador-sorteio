...
export default function JogoBicho() {
  ...
  function revelar() {
    ...
    const aleatorio = Math.floor(Math.random() * animais.length);
    setAnimalGerado(animais[aleatorio]);
  }
    ...
    <View style={styles.container}>
      <Card style={styles.card}>
        <Card.Content>
          ...
          <Text variant='displaySmall'>Número: {animalGerado.numero}</Text>
          <Card.Cover style={styles.foto} source={{ uri: animalGerado.imagem }} />
        </Card.Content>
        <Card.Actions style={styles.acoes}>
          <Button mode='contained' onPress={revelar}>Revelar</Button>
        </Card.Actions>
      </Card>
    </View>
  );
